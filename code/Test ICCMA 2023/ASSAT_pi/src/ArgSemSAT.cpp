...
int main(int argc, char *argv[])
{
    ...
    clock_t end = clock();
	double elapsed_time_seconds = static_cast<double>(end - start) / CLOCKS_PER_SEC; // 转换为秒
    double elapsed_time_rounded = round(elapsed_time_seconds * 100) / 100; // 四舍五入到小数点后两位

    std::cout << elapsed_time_rounded << "s\n";
